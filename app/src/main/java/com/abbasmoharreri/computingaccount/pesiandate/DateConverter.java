package com.abbasmoharreri.computingaccount.pesiandate;
...
public class DateConverter {
    ...
    public DateConverter(int year, int month, int day, int hour, int minute) {
        setGregorianDate( year, month, day );
        this.hour = hour;
        this.minute = minute;
    }
    ...
    public DateConverter setHour(int hour) {
        this.hour = hour;
        return this;
    }

    public DateConverter setMinute(int minute) {
        this.minute = minute;
        return this;
    }
